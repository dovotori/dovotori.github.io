...
`,Text=styled_components_browser_esm.Ay.p`
  margin: 10px 0;
  width: 100%;
`,DateComp=styled_components_browser_esm.Ay.p.attrs({className:"numbers"})`
  text-align: left;
  margin: 0;
