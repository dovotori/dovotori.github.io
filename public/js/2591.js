...
`,m=e=>{let{slug:t,images:o,colorType:i,labo:r}=e;return(0,p.jsxs)(p.Fragment,{children:[!!r&&(0,p.jsx)(y,{slug:t,$colorType:i,colorType:i,noBackground:!!r.noBackground,hasHtml:!!r.hasHtml,hasJs:!!r.hasJs}),o&&(0,p.jsx)(u,{children:Array(o).fill().map(((e,t)=>t)).map((e=>(0,p.jsx)(d,{idx:e,slug:t,$colorType:i},`image-${t}-${e}`)))}),(0,p.jsx)(s.A,{$colorType:null})]})};var b=o(85651);const f=()=>{const e=(0,i.g)().slug||null,t=(0,b.XJ)(e);return(0,p.jsx)(m,{colorType:(0,r.G7)(t.category),...t})}},47695:(e,t,o)=>{o.d(t,{Wx:()=>d});var i=o(96540),r=Object.defineProperty,n=(e,t,o)=>(((e,t,o)=>{t in e?r(e,t,{enumerable:!0,configurable:!0,writable:!0,value:o}):e[t]=o})(e,"symbol"!=typeof t?t+"":t,o),o),s=new Map,l=new WeakMap,a=0,c=void 0;function p(e){return Object.keys(e).sort().filter((t=>void 0!==e[t])).map((t=>{return`${t}_${"root"===t?(o=e.root,o?(l.has(o)||(a+=1,l.set(o,a.toString())),l.get(o)):"0"):e[t]}`;var o})).toString()}function h(e,t,o={},i=c){if(void 0===window.IntersectionObserver&&void 0!==i){const r=e.getBoundingClientRect();return t(i,{isIntersecting:i,target:e,intersectionRatio:"number"==typeof o.threshold?o.threshold:0,time:0,boundingClientRect:r,intersectionRect:r,rootBounds:r}),()=>{}}const{id:r,observer:n,elements:l}=function(e){const t=p(e);let o=s.get(t);if(!o){const i=new Map;let r;const n=new IntersectionObserver((t=>{t.forEach((t=>{var o;const n=t.isIntersecting&&r.some((e=>t.intersectionRatio>=e));e.trackVisibility&&void 0===t.isVisible&&(t.isVisible=n),null==(o=i.get(t.target))||o.forEach((e=>{e(n,t)}))}))}),e);r=n.thresholds||(Array.isArray(e.threshold)?e.threshold:[e.threshold||0]),o={id:t,observer:n,elements:i},s.set(t,o)}return o}(o),a=l.get(e)||[];return l.has(e)||l.set(e,a),a.push(t),n.observe(e),function(){a.splice(a.indexOf(t),1),0===a.length&&(l.delete(e),n.unobserve(e)),0===l.size&&(n.disconnect(),s.delete(r))}}i.Component;function d({threshold:e,delay:t,trackVisibility:o,rootMargin:r,root:n,triggerOnce:s,skip:l,initialInView:a,fallbackInView:c,onChange:p}={}){var d;const[g,u]=i.useState(null),y=i.useRef(),[m,b]=i.useState({inView:!!a,entry:void 0});y.current=p,i.useEffect((()=>{if(l||!g)return;let i;return i=h(g,((e,t)=>{b({inView:e,entry:t}),y.current&&y.current(e,t),t.isIntersecting&&s&&i&&(i(),i=void 0)}),{root:n,rootMargin:r,threshold:e,trackVisibility:o,delay:t},c),()=>{i&&i()}}),[Array.isArray(e)?e.toString():e,g,n,r,s,l,o,c,t]);const f=null==(d=m.entry)?void 0:d.target,v=i.useRef();g||!f||s||l||v.current===f||(v.current=f,b({inView:!!a,entry:void 0}));const $=[u,m.inView,m.entry];return $.ref=$[0],$.inView=$[1],$.entry=$[2],$}}}]);