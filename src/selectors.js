...
export const getCategories = () => useContext(StateContext).state.content.categories;
...
export const getIsTouchDevice = () => useContext(StateContext).state.device.isTouch;
export const getIsDarkMode = () => useContext(StateContext).state.device.isDarkMode;
export const getContentBack = () => useContext(StateContext).state.content.back;
export const getContentPrevious = () => useContext(StateContext).state.content.previous;
...
export const getCategoryId = () => useContext(StateContext).state.device.category;
