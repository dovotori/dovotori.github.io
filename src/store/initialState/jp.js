  ...
  cv: {
    formation: {
      ...
      items: [
        ...
        {
          date: 2013,
          text: 'サンテティエンヌのデザインの国際隔年で、バラソンプロジェクトで展示 バラソンプロジェクト',
        },
        {
          date: 2012,
          text: 'マルチメディア部門 / バーチャルリアリティ Burg Giebichenstein の 美術学校 に Halle, ドイツ',
        },
        {
          date: 2011,
          text: 'サンテティエンヌ の 芸術とデザイン の 優れた学校 の 造形芸術 の 国立ディプロマ デザインセクション',
        },
        {
          date: 2009,
          text: 'グラフィックデザイン の 卒業証書/ LISAA Paris の 応用芸術の高等研究所でのマルチメディア',
        },
        {
          date: 2006,
          text: '一般科学バカロレア',
    ...
    jobs: {
      ...
      items: [
        ...
        },
        {
          startDate: 2014,
          endDate: 2016,
          text: 'Pix 21 の ウェブデザイン の 会社 の 共同マネージャー, グラフィックデザイン と ウェブ開発 の 責任者',
          tasks: [
            'ウェブサイト の 開発 と 展開',
        ...
        },
        {
          startDate: 2012,
          endDate: 2012,
          text: 'グルノーブル に 研究所 の Ideas Lab au CEA 学期をしました',
          tasks: [
        ...
        },
        {
          startDate: 2009,
          endDate: 2009,
          text: 'コンサルティングおよびグラフィックデザインエージェンシー の atelier des Giboulées の 会社 で ビジネスインターンシップ を しました',
          tasks: [
