...
export const easeInQuad = (t, b, c, d) => { const tt = t / d; return c * tt * tt + b; };
export const easeOutQuad = (t, b, c, d) => { const tt = t / d; return -c * tt * (tt - 2) + b; };
export const easeInCubic = (t, b, c, d) => { const tt = t / d; return c * tt * tt * tt + b; };
export const easeOutCubic = (t, b, c, d) => {
  const tt = t / d - 1; return c * (tt * tt * tt + 1) + b;
};
...
export const easeInQuart = (t, b, c, d) => { const tt = t / d; return c * tt * tt * tt * tt + b; };
export const easeOutQuart = (t, b, c, d) => {
  const tt = t / d - 1; return -c * (tt * tt * tt * tt - 1) + b;
};
...
export const easeInQuint = (t, b, c, d) => {
  const tt = t / d; return c * tt * tt * tt * tt * tt + b;
};

export const easeOutQuint = (t, b, c, d) => {
  const tt = t / d - 1; return c * (tt * tt * tt * tt * tt + 1) + b;
};
...
export const easeInCirc = (t, b, c, d) => {
  const tt = t / d; return -c * (Math.sqrt(1 - tt * tt) - 1) + b;
};

export const easeOutCirc = (t, b, c, d) => {
  const tt = t / (d - 1); return c * Math.sqrt(1 - tt * tt) + b;
};
...
export const easeOutElastic = (t, b, c, d) => {
  ...
  return (
    a * (2 ** (-10 * tt)) * Math.sin(((tt * d - s) * (2 * Math.PI)) / p)
    + c
    + b
  );
};
